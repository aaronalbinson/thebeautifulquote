        ...
        <div className="column is-12 is-6-tablet is-3-desktop">
          <div className="kilimanjaro_part">
            ...
            <p>
              ...
              based on One Page/ Multi-page Layout,blog themes,world press
          ...
          <div classNameName="kilimanjaro_part m-top-15">
            <h5>Social Links</h5>
            <ul className="kilimanjaro_social_links">
              ...
              <li>
                <a href="#">
                  <i className="fa fa-pinterest" aria-hidden="true" /> Pinterest
                </a>
              </li>
              <li>
                <a href="#">
